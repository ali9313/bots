...
@bot.message_handler(func=lambda a: is_running and a.from_user.id in muted_users)
...
@bot.message_handler(func=lambda a: is_running)
def echo_message(a):
    reply_func(a)

# بدء تشغيل البوت وتفعيل المتغير
is_running = True
bot.polling()